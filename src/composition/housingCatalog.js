/**
 * Static housing catalog for presentation (no getOrCreate). Live housing
...
export { describeNextTierRequirements } from '../contexts/housing/domain/policies/HouseLevelPolicy.js';

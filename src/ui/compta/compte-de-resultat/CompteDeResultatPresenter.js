 ...
 */
export function renderFinancialStatementsBundles(bundles, container) {
        ...
        <div class="budget-state-item">
            ...
            <div class="budget-income-statement">
                <div class="statement-section">
                    ...
                    ${incomeStatement.products
                      .filter((p) => p.label !== 'Impôt citoyen')
                      .map(
                        (p) => `
                    <div class="statement-line">
 ...
 * @param {Array<object>} bundles
 * @param {HTMLElement} container
 * @param {object|null} [fiscalYearStatement]
 */
export function renderBudgetSummary(bundles, container, fiscalYearStatement = null) {

...
import { getObjectivesManager, getButtonStateManager, registerAppService } from '../js/acl/appRuntime.js';
import { getObjectivesStore } from '../js/acl/objectives.js';
import {
  OBJECTIVE_CATALOG,
  isObjectiveRequirementMet,
} from '../js/acl/objectives.js';
